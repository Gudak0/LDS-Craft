...
val neutronium_collector_t2 = Builder.start("mbt:neutronium_collector_t2")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t2")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t2.hasMufflerMechanics = false;
					neutronium_collector_t2.hasMaintenanceMechanics = false;
	
neutronium_collector_t2.recipeMap
	.recipeBuilder()
	.duration(12600)
	.EUt(1048576)
