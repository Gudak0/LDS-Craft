...
val neutronium_collector_t11 = Builder.start("mbt:neutronium_collector_t11")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t11")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t11.hasMufflerMechanics = false;
					neutronium_collector_t11.hasMaintenanceMechanics = false;
	
neutronium_collector_t11.recipeMap
	.recipeBuilder()
	.duration(1)
	.EUt(8)
