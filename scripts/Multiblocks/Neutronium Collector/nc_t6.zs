...
val neutronium_collector_t6 = Builder.start("mbt:neutronium_collector_t6")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t6")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t6.hasMufflerMechanics = false;
					neutronium_collector_t6.hasMaintenanceMechanics = false;
	
neutronium_collector_t6.recipeMap
	.recipeBuilder()
	.duration(7000)
	.EUt(131072)
