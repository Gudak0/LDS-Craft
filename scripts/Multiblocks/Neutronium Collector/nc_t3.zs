...
val neutronium_collector_t3 = Builder.start("mbt:neutronium_collector_t3")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t3")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t3.hasMufflerMechanics = false;
					neutronium_collector_t3.hasMaintenanceMechanics = false;
	
neutronium_collector_t3.recipeMap
	.recipeBuilder()
	.duration(11200)
	.EUt(524288)
