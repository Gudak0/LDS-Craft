...
val neutronium_collector_t8 = Builder.start("mbt:neutronium_collector_t8")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t8")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t8.hasMufflerMechanics = false;
					neutronium_collector_t8.hasMaintenanceMechanics = false;
	
neutronium_collector_t8.recipeMap
	.recipeBuilder()
	.duration(4200)
	.EUt(32767)
