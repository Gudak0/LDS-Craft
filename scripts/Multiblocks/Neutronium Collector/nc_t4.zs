...
val neutronium_collector_t4 = Builder.start("mbt:neutronium_collector_t4")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t4")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t4.hasMufflerMechanics = false;
					neutronium_collector_t4.hasMaintenanceMechanics = false;
	
neutronium_collector_t4.recipeMap
	.recipeBuilder()
	.duration(9800)
	.EUt(262144)
