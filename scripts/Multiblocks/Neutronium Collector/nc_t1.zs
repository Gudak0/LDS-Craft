...
val neutronium_collector_t1 = Builder.start("mbt:neutronium_collector_t1")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t1")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t1.hasMufflerMechanics = false;
					neutronium_collector_t1.hasMaintenanceMechanics = false;
	
neutronium_collector_t1.recipeMap
	.recipeBuilder()
	.duration(14000)
	.EUt(2097152)
