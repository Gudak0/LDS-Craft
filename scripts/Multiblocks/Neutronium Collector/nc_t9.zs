...
val neutronium_collector_t9 = Builder.start("mbt:neutronium_collector_t9")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t9")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t9.hasMufflerMechanics = false;
					neutronium_collector_t9.hasMaintenanceMechanics = false;
	
neutronium_collector_t9.recipeMap
	.recipeBuilder()
	.duration(2800)
	.EUt(8192)
