...
val neutronium_collector_t10 = Builder.start("mbt:neutronium_collector_t10")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t10")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t10.hasMufflerMechanics = false;
					neutronium_collector_t10.hasMaintenanceMechanics = false;
	
neutronium_collector_t10.recipeMap
	.recipeBuilder()
	.duration(1400)
	.EUt(4096)
