...
val neutronium_collector_t7 = Builder.start("mbt:neutronium_collector_t7")
	.withPattern(function(controller as IControllerTile) as IBlockPattern {
						...
						.withRecipeMap(
							FactoryRecipeMap.start("neutronium_collector_t7")
							.minInputs(1)
							.maxInputs(1)
							.minOutputs(1)
							.maxOutputs(1)
					...
					neutronium_collector_t7.hasMufflerMechanics = false;
					neutronium_collector_t7.hasMaintenanceMechanics = false;
	
neutronium_collector_t7.recipeMap
	.recipeBuilder()
	.duration(5600)
	.EUt(65536)
